...
* <span style="color:red">**Myth 3:</span> CO~2~ can’t be responsible for climate change – plants, crops, and trees remove CO~2~ to grow**
...
* **Global temperature rise**
    + The planet's average surface temperature has risen 1.1 degrees Celsius (°C) – since the pre-industrial era. The rate of increase has doubled in the past 40 years. Last 10 years = warmest during this period.
...
* **Shrinking ice sheets and glaciers**
    ...
    + https://ed-hawkins.github.io/climate-visuals/SPIRALS/arctic-ice-volume-2024.gif
...
https://ed-hawkins.github.io/climate-visuals/SPIRALS/global_temperature_spiral_latest_large.gif
...
* **Climate is the average pattern of weather for a particular region and time period, using scientific data collected over decades. The terms global warming and climate change refer to a broad temperature shift across the entire earth's surface over the course of decades.**
...
## 
**If trees could balance the CO~2~, what would the Mauna Loa graph really look like?**

<IMG STYLE="position:absolute; TOP:110px; LEFT:200px; WIDTH:700px; HEIGHT:600px" SRC="images/co2_data_mlo.png">
...
<hr>
**It took 12 years for the world population to grow from 7 to 8 billion (2010-2022)**

<IMG STYLE="position:absolute; TOP:200px; LEFT:50px; WIDTH:960px; HEIGHT:480px" SRC="images/humanpop.png">
...
* **One of those rare scientific terms that has entered the public consciousness, which is ironic, given that geologists have rejected it**
...
* **Various phenomena associated with this new epoch** 
    ...
    + impact extends to ecosystem changes such as rampant deforestation and biodiversity loss

</div>

<IMG STYLE="position:absolute; TOP:220px; LEFT:20px; WIDTH:420px; HEIGHT:450px" SRC="images/timesprial.jpg">
...
<IMG STYLE="position:absolute; TOP:245px; LEFT:10px; WIDTH:380px; HEIGHT:340px" SRC="images/doom.jpg">
